package com.inditextech.intelhub.test.handler;

import com.inditextech.intelhub.handlers.MessageRouterHandler;
import com.inditextech.intelhub.service.CertificationService;
import com.inditextech.intelhub.service.WebViewerWindowService;
import com.inditextech.intelhub.test.TestUtils;
...
public class MessageRouterHandlerTest {
    ...
    public void should_show_message_when_it_is_not_an_api_folder() {
        ...
        try (MockedStatic<ProjectView> projectViewMock = mockStatic(ProjectView.class);
            ...
            when(notificationGroupManagerImpl.getNotificationGroup("APIScoring")).thenReturn(notificationGroup);
