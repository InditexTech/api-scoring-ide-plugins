...
export class HubController implements CertificationFrontendControllerIface {
    ...
    onClickValidateFile(payload: ValidationFileModuleType): void {
        vscode.commands.executeCommand('apiHub.certification.validateFile', payload);
    }

    getValidationRules(): void {
        vscode.commands.executeCommand('apiHub.certification.getValidationRules');
    }
    
    onClickValidateModule(payload: ValidationModuleType): void {
        vscode.commands.executeCommand('apiHub.certification.validateRepository', payload);
    }
