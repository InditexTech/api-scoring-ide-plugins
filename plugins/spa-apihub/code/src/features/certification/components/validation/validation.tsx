...
import ValidationResult from "components/validation-result/validation-result";
import { AccordionControl } from "./accordion-control";
import RevalidateModuleAction from "./revalidate-module-action";
import type { Certification, CertificationPayload, ModuleMetadata, RevalidateModule, ValidationTypes } from "types";
